...
def create_model(cat_idxs = None):
    model = ExtraTreesRegressor(random_state=random.randint(3, 1000), n_estimators=5000, verbose=100)
    search_params = {'max_leaf_nodes': [3, 7, 15]}
...
load_model = load("./model/hcm/etr/v1/model.joblib")
