...
def create_model(cat_idxs = None):
    model = GradientBoostingRegressor(n_estimators = 5000, random_state=random.randint(3, 1000), verbose=100)
...
load_model = load("./model/hcm/gbr/v1/model.joblib")
