...
def create_model(cat_idxs = None):
    model = RandomForestRegressor(random_state=random.randint(3, 1000), n_estimators=5000)
    search_params = {'max_depth': [3, 7, 15]}
...
load_model = load("./model/hcm/rf/v1/model.joblib")
