...
def create_model(cat_idxs = None):
    model = XGBRegressor(n_estimators = 5000, random_state=random.randint(3, 1000), verbose = 100, device = 'gpu')
...
load_model = load("./model/hcm/xgb/v2/model.joblib")
